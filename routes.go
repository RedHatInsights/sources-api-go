...
func setupRoutes(e *echo.Echo) {
	...
	for _, version := range apiVersions {
		...
		r.PATCH("/authentications/:uid", AuthenticationUpdate, append(permissionMiddleware, middleware.Notifier)...)
		...
		r.PATCH("/rhc_connections/:id", RhcConnectionUpdate, append(permissionMiddleware, middleware.Notifier)...)
