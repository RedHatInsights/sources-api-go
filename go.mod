...
require (
	...
	github.com/lestrrat-go/jwx/v2 v2.1.6 // Comprehensive JWT/JWK library for JWKS support - enables dynamic key discovery, advanced JWT operations, and JSON Web Key Set handling for OIDC authentication
	...
	github.com/stretchr/testify v1.11.1 // Enhanced testing framework for JWT/OIDC auth - provides clearer assertions, better error messages, and separates fatal (require) vs non-fatal (assert) test conditions
